...
| **Entry (office, slim)** | `assets/hardware/Flux2-dev-t2i-office-slim-gold_00001_.png` | Slimmer FABIABox with small gold F emblem, no RGB contour light, cup/notebook for scale. |
