#!/usr/bin/env python3
"""Generate a FABIABox image-to-video clip using native Wan 2.2 i2v models."""
import argparse
import json
import os
import random
...
WORKFLOW_PATH = os.path.join(os.path.dirname(__file__), "..", "assets", "workflows", "wan22_i2v_image_to_video.json")
...
PROMPT = (
    ...
    "A single lit beeswax birthday candle flickers on top. The device sits on a polished wooden desk, "
...
def main():
    ...
    workflow["78"]["inputs"]["noise_seed"] = args.seed

    print(f"Queueing Wan 2.2 native i2v (seed {args.seed})...")
