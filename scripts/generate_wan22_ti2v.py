#!/usr/bin/env python3
"""Generate a FABIABox image-to-video clip using Wan 2.2 5B TI2V."""
import argparse
import json
import os
import random
...
WORKFLOW_PATH = os.path.join(os.path.dirname(__file__), "..", "assets", "workflows", "wan22_ti2v_image_to_video.json")
...
CROP_NAME = "fabiabox_birthday_ti2v_input.jpg"
...
def crop_to_16x9(input_path, out_path, width=1280, height=704):
