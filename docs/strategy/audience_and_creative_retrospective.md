...
### 3.4 EU intent-qualified adset (2026-07-10)

- **Goal:** clone the high-performing US interest stack into the EU and run only the top EU creatives plus V3.1 there.
- **EU performance before the move:**

| Ad | Creative angle | Status | Impressions | Clicks | CTR | CPC |
|---|---|---:|---:|---:|---:|---:|
| V5 — “SAAS IS DEAD. SOVEREIGN AI IS BORN.” | sovereignty / local AI | ACTIVE | 15,101 | 613 | **4.06%** | **€0.055** |
| V4 — “Build a company without coding” | no-code outcome | ACTIVE | 425 | 13 | 3.06% | €0.054 |
| V2 — “YOUR AI CO-FOUNDER” | concrete co-founder | ACTIVE | 651 | 15 | 2.30% | €0.075 |
| V6 — “WHY RENT AI WHEN YOU CAN OWN THE FOUNDRY?” | sovereignty | ACTIVE | 10,467 | 227 | 2.17% | €0.130 |
| V3.1 — “YOUR AI CO-FOUNDER. SHIP YOUR COMPANY.” | combined winner | ACTIVE | 926 | 40 | 4.32% | €0.055 |
| V3 — “Own the stack — ship fast” | abstract ship | **PAUSED** | 183 | 3 | 1.64% | €0.047 |
| V1 — “Human co-founder” | soft / generic | **PAUSED** | 1,875 | 17 | 0.91% | €0.234 |

- **Low performers paused:** EU V1 (`120249350226320462`) and EU V3 (`120249350233090462`).
- **Clean adset created:** 44 duplicate attempts were generated by a retry loop; all but the first were deleted. The survivor was renamed and budget-matched to the US adset.
  - **EU intent adset:** `120249476780370462` — `FABIABox — Website Prospecting — EU Founders`
  - **Daily budget:** €25.00 (matches US adset)
  - **Targeting:** age 25–55, all genders, EU countries (IT, NL, ES, GB, FR, DE), same interest stack as US:
    - Small business (`6002884511422`)
    - Artificial intelligence (`6002898176962`)
    - Start-up company (`6003325004380`)
    - Software as a service (`6003344765839`)
    - Entrepreneurship (`6003371567474`)
  - **Optimization:** `LANDING_PAGE_VIEWS`, `LOWEST_COST_WITHOUT_CAP`, Advantage Audience disabled.
- **Ads attached to the new EU adset (reusing existing creatives):**
  - V3.1 (`120249477621180462`) — creative `2085268062410129`
  - V4 (`120249477622190462`) — creative `1786082196103504`
  - V5 (`120249477623040462`) — creative `1003052672475163`
- **Why these three:** V5 is the EU volume winner, V4 has the best efficiency on small sample, and V3.1 is the rewritten variant that explicitly combines the sovereignty + co-founder angles. Keeping the adset to 3 creatives gives each variant enough daily impressions to learn on a €25 budget.
- **Other interesting interest targets found via the Meta API:**
  - `6003284619527` — **Venture capital** (~8.7–10.2M)
  - `6002967067555` — **Seed accelerator** (~1.3–1.6M)
  - `6003318751818` — **Angel investor** (~2.3–2.7M)
  - `6003716679307` — **Product management** (~30.6–36.0M)
